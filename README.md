...
The EA in this example is only a placeholder for the function to detect and scale in. The EA itself is not even complete.

What this is showing is a function (actually 3 functions) that will determine if the nearest trade is in profit enough to enter a new trade.
The EA here does not do much with that information other than to open a new trade but how the information is used is up to your
expert, this is just to show how to detect those situations where your entire portfolio is in profit.
